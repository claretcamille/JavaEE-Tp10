 ...
 */
public class ControlDao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Dans le cas ou l'utilisateur souhaite supprimer une valeur
         if(action.equals("DELETE")){
            ...
            if(action.equals("ADD")){
               ...
               myDao.createVal(key, val);
            }
            request.setAttribute("HT", myDao.discountCodeList());
